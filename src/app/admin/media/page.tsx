    ...
    return (
        <div className="max-w-7xl mx-auto pb-12">
            <div className="mb-6 flex justify-between items-end">
                <div>
                    <h2 className="text-2xl font-bold tracking-tight text-[#111827] mb-1">Central Media Library</h2>
                    <p className="text-[#6B7280] text-sm">Upload, compress, and manage media assets. Click any card to inspect the full image.</p>
                </div>
            ...
            <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 xl:grid-cols-6 gap-3.5">
                {mediaItems.length === 0 ? (
                    <div className="col-span-full border border-dashed border-gray-200 rounded-2xl p-12 text-center bg-white/50">
                        ...
                        <p className="text-[#9CA3AF] text-xs max-w-sm mx-auto">Upload images or videos here. They will be automatically compressed and reusable across all website sections.</p>
                    </div>
                ) : (
