    ...
    return (
        <div className="max-w-5xl mx-auto pb-12">
            <div className="mb-8 flex justify-between items-end">
                <div>
                    <h2 className="text-2xl font-bold tracking-tight text-white mb-2">Home Page Logos</h2>
                    <p className="text-white/60">Manage logos for the Home page "Trusted By" section.</p>
                </div>
                <button
            ...
            <div className="bg-[#111111] border border-white/10 rounded-xl overflow-hidden">
                <table className="w-full text-left text-sm text-white/80">
                    ...
                    <tbody className="divide-y divide-white/5">
                        {logos.length === 0 ? (
                            <tr>
                                <td colSpan={5} className="p-8 text-center text-white/40">No logos found for the Home page.</td>
                            </tr>
                        ) : (
                            logos.map(logo => (
