    ...
    return (
        <div className="max-w-6xl mx-auto pb-12">
            <div className="mb-8 flex justify-between items-end">
                <div>
                    <h2 className="text-2xl font-bold tracking-tight text-[#111827] mb-2">Home Page Media</h2>
                    <p className="text-[#6B7280]">Upload and manage media assets specifically designated for the Home page.</p>
                </div>
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
                {mediaItems.length === 0 ? (
                    <div className="col-span-full border border-dashed border-gray-200/20 rounded-xl p-12 text-center">
                        ...
                        <p className="text-[#9CA3AF] text-sm">Upload media elements specifically scoped for the Home page layout.</p>
                    </div>
                ) : (
