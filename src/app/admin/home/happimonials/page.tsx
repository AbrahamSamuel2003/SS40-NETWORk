    ...
    return (
        <div className="max-w-6xl mx-auto pb-12">
            <div className="mb-8 flex justify-between items-end">
                <div>
                    <h2 className="text-2xl font-bold tracking-tight text-white mb-2">Home Page Happimonials</h2>
                    <p className="text-white/60">Manage content for the Home page "Success Stories" section.</p>
                </div>
                ...
                <table className="w-full text-left text-sm text-white/80">
                    ...
                    <tbody className="divide-y divide-white/5">
                        {happimonials.length === 0 ? (
                            <tr><td colSpan={4} className="p-8 text-center text-white/40">No entries specific to Home found.</td></tr>
                        ) : (
