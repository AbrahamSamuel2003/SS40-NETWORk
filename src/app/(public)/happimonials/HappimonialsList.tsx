                                ...
                                <div className="p-5 md:p-6 flex flex-col flex-1">
                                    ...
                                    <div className="mt-auto pt-4 border-t border-gray-100 flex items-center justify-between gap-3">
                                        <div className="flex items-center gap-2.5 min-w-0">
                                            {item.thumbnailUrl && (
                                                <div className="relative w-8 h-8 rounded-full overflow-hidden shrink-0 border border-gray-100 shadow-sm">
                                                    <NextImage src={item.thumbnailUrl} alt={item.clientName} fill className="object-cover" sizes="32px" />
                                                </div>
                                            )}
                                        ...
                                        <div className="flex items-center gap-2 shrink-0">
                                            ...
                                            <button
                                                onClick={(e) => { e.stopPropagation(); setActiveModalStory(item); }}
