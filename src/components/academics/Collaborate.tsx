...
export function Collaborate() {
    return (
        <SectionWrapper id="collaborate" className="bg-[#D8E8E2] relative overflow-hidden pt-4 pb-20 md:pt-8 md:pb-32">
            ...
            <Container className="relative z-10 max-w-5xl mx-auto flex flex-col items-center">
                ...
                <SectionHeading
                    ...
                    description="Whether you're a student, an educational institution, or an industry partner, we're ready to build meaningful opportunities together."
                    className="mb-16"
                />
                    ...
                    {CARDS.map((card, idx) => {
                        ...
                        return (
                            ...
                            >
                                ...
                                <div className="w-14 h-14 bg-[#D8E8E2] rounded-xl flex items-center justify-center mb-6 border border-gray-100 group-hover:bg-[#6B9F91]/5 group-hover:border-[#6B9F91]/20 transition-colors">
