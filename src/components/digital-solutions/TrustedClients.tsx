...
export function TrustedClients() {
    return (
        <SectionWrapper id="trusted-clients" className="bg-[#F2F7F5] relative overflow-hidden">
            ...
            <div className="relative z-10 w-full flex flex-col gap-6 md:gap-8 overflow-hidden py-4">
                ...
                {/* Updated gradient from White to #[#F2F7F5] to match section background */}
                <div className="absolute top-0 bottom-0 left-0 w-24 md:w-32 bg-gradient-to-r from-[#F2F7F5] to-transparent z-20 pointer-events-none" />
                <div className="absolute top-0 bottom-0 right-0 w-24 md:w-32 bg-gradient-to-l from-[#F2F7F5] to-transparent z-20 pointer-events-none" />
