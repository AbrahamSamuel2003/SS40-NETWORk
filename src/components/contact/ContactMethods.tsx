    ...
    return (
        <SectionWrapper id="contact-methods" className="bg-[#D8E8E2] py-12 md:py-16">
            <Container className="max-w-5xl mx-auto">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-3 sm:gap-4 max-w-2xl mx-auto items-stretch">
                    {channels.map((channel, idx) => {
                        ...
                        return (
                            ...
                            >
                                ...
                                <div className="w-9 h-9 sm:w-10 sm:h-10 rounded-xl bg-[#6B9F91]/10 border border-[#6B9F91]/20 flex items-center justify-center text-[#6B9F91] mb-3 sm:mb-3.5 group-hover:bg-[#6B9F91]/15 group-hover:border-[#6B9F91]/30 group-hover:scale-105 transition-all duration-200">
